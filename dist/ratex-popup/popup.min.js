...
function createDisplay(){var popupElement=document.createElement('div');popupElement.className=popup.popupContainerClass;popupElement.id='popupContainerOut';popupElement.innerHTML="<img id="+popup.imageId+" />"+"<div class=textContainer>"+"<div class=closeContainer>"+"<div id="+popup.titleId+"></div>"+"<svg id="+popup.closeId+"></svg>"+"</div>"+"<div id="+popup.nameId+"></div>"+"<div id="+popup.timeId+"></div>";document.body.appendChild(popupElement);createX();popupElement.onclick=function(e){if(e.target.id===popup.closeId){closePopup()}else{openInNewTab()}}}
function createX(){var svg=document.getElementById(popup.closeId);svg.setAttribute("xmlns","http://www.w3.org/2000/svg");svg.setAttribute("width","15");svg.setAttribute("height","16");svg.setAttribute("viewPort","0 0 15 16");svg.setAttribute("fill","none");var line1=document.createElementNS("http://www.w3.org/2000/svg","line");line1.setAttribute("x1","1");line1.setAttribute("y1","11");line1.setAttribute("x2","11");line1.setAttribute("y2","1");line1.setAttribute("stroke","white");line1.setAttribute("stroke-width","2");svg.appendChild(line1);var line2=document.createElementNS("http://www.w3.org/2000/svg","line");line2.setAttribute("x1","1");line2.setAttribute("y1","1");line2.setAttribute("x2","11");line2.setAttribute("y2","11");line2.setAttribute("stroke","white");line2.setAttribute("stroke-width","2");svg.appendChild(line2)}
