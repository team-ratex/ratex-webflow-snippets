...
function createDisplay(){var popupElement=document.createElement('div');popupElement.className=popup.popupContainerClass;popupElement.id='popupContainerOut';popupElement.innerHTML="<img id="+popup.imageId+" />"+"<div class=textContainer>"+"<div class=closeContainer>"+"<div id="+popup.titleId+"></div>"+"<svg id='"+popup.closeId+"' xmlns=http://www.w3.org/2000/svg "+"viewPort= '0 0 15 16' fill= none>"+"<line x1=1 y1=15 x2= 16 y2=1 stroke=white stroke-width=2></line>"+"<line x1=1 y1=1 x2= 15 y2=16 stroke=white stroke-width=2></line>"+"</svg>"+"</div>"+"<div id="+popup.nameId+"></div>"+"<div id="+popup.timeId+"></div>";document.body.appendChild(popupElement);popupElement.onclick=function(e){if(e.target.id===popup.closeId){closePopup()}else{openInNewTab()}}}
